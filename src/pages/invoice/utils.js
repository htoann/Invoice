...
export const handleDataTable = (loaiHoaDon) => {
  return [
    ...
    {
      title: loaiHoaDon === 'sold' ? i18next.t('Invoice_BuyerTaxCode') : i18next.t('Invoice_ReceiverTaxCode'),
      dataIndex: 'mst',
      key: 'mst',
      sorter: (a, b) => a.mst.props.children.localeCompare(b.mst.props.children),
    },
    {
      title: loaiHoaDon === 'sold' ? i18next.t('Invoice_BuyerName') : i18next.t('Invoice_ReceiverName'),
      dataIndex: 'ten',
      key: 'ten',
    ...
    {
      title: i18next.t('Invoice_InvoiceLink'),
      dataIndex: 'linkhd',
      key: 'linkhd',
    ...
    {
      title: i18next.t('Invoice_Address'),
      dataIndex: 'diachitd',
      key: 'diachitd',
