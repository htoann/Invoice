...
export const useInvoiceDataTable = () => {
  ...
  return [
    {
      title: t('Invoice_DataTable_Index'),
      dataIndex: 'id',
      key: 'id',
    },
    {
      title: t('Invoice_DataTable_ModelCode'),
      dataIndex: 'khmshdon',
      key: 'khmshdon',
      sorter: (a, b) => a.khmshdon.props.children - b.khmshdon.props.children,
    },
    {
      title: t('Invoice_DataTable_InvoiceCode'),
      dataIndex: 'khhdon',
      key: 'khhdon',
      sorter: (a, b) => a.khhdon.props.children.localeCompare(b.khhdon.props.children),
    },
    {
      title: t('Invoice_DataTable_InvoiceNumber'),
      dataIndex: 'shdon',
      key: 'shdon',
