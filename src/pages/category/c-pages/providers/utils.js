...
export const fieldsModalProvider = [
  ...
  { name: 'tax_code', label: 'Provider_TaxCode', type: 'input', required: true },
  { name: 'address', label: 'Provider_Address', type: 'input' },
  { name: 'phone_number', label: 'Provider_PhoneNumber', type: 'input' },
  { name: 'website', label: 'Provider_Website', type: 'input' },
  ...
  { name: 'num_of_days_debt', label: 'Provider_NumOfDaysDebt', type: 'input' },
  { name: 'max_debt_amount', label: 'Provider_MaxDebtAmount', type: 'input' },
  { name: 'account_payable', label: 'Provider_AccountPayable', type: 'input' },
  ...
  { name: 'country', label: 'Provider_Country', type: 'input' },
  { name: 'province', label: 'Provider_Province', type: 'input' },
  { name: 'district', label: 'Provider_District', type: 'input' },
  { name: 'ward', label: 'Provider_Ward', type: 'input' },
  { name: 'contact_person_title', label: 'Provider_ContactPersonTitle', type: 'input' },
  { name: 'contact_person_name', label: 'Provider_ContactPersonName', type: 'input' },
  { name: 'contact_person_phone_number', label: 'Provider_ContactPersonPhoneNumber', type: 'input' },
  { name: 'contact_person_email', label: 'Provider_ContactPersonEmail', type: 'input' },
  { name: 'legal_representative', label: 'Provider_LegalRepresentative', type: 'input' },
  { name: 'delivery_address', label: 'Provider_DeliveryAddress', type: 'input' },
  { name: 'is_individual', label: 'Provider_IsIndividual', type: 'checkbox' },
