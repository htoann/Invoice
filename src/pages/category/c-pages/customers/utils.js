...
export const fieldsModalProvider = [
  ...
  { name: 'num_of_days_debt', label: 'Provider_NumOfDaysDebt', type: 'number' },
  { name: 'max_debt_amount', label: 'Provider_MaxDebtAmount', type: 'number' },
  ...
  { name: 'contact_person_email', label: 'Provider_ContactPersonEmail', type: 'email' },
